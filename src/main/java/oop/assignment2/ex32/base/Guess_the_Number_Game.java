...
Once the player guesses the correct number, the computer should present the number of guesses and ask if
...
public class Guess_the_Number_Game {
    ...
    public static void main(String[] args) {
        ...
        int randomNumber = RandomNumberGenerator.randomNum(getData.difficultyLevel());

        System.out.println(randomNumber);

        String answer = GuessChecker.guessNum(randomNumber);


        while(true) {
            if (answer.equals("Y")){
                randomNumber = RandomNumberGenerator.randomNum(getData.difficultyLevel());

                answer = GuessChecker.guessNum(randomNumber);
