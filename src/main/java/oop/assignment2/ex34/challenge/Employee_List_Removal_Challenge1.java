package oop.assignment2.ex34.challenge;

import oop.assignment2.Tools.Print;
import oop.assignment2.ex34.base.RemoveName;
...
public class Employee_List_Removal_Challenge1 {
    ...
    public static void main(String[] args) {
        ...
        deleteName = validInputChecker(employeeArray, deleteName);
    ...
    public static String validInputChecker(String[] haystack, String needle) {
        ...
        while (true) {
            ...
            System.out.print("The name does not exist, please enter a valid name: ");
