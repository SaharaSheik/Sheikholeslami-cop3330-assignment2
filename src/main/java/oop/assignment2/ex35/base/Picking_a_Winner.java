...
public class Picking_a_Winner {
    public static void main(String[] args) {
        ArrayList<String> nameList = ArrayMaker.nameArrayMaker();
        int winningNum = Pseudo_Random_Number_Generator.pseudoRandomNumber(nameList.size());
        PrintWinner.printName(nameList.get(winningNum-1));
