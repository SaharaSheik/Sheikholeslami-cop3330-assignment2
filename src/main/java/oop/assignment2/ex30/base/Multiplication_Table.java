...
Challenges
Create a graphical program. Use a drop-down list to change the base number. Generate or update
the table when the number is selected.
 */
...
public class Multiplication_Table {
    ...
    public static void main(String[] args) {
        int row = 12, col=12;
        int[][] array = multiplicationArrayGenerator.multiplier(row, col);
        printer.printArray(array, row, col);
    }
}
